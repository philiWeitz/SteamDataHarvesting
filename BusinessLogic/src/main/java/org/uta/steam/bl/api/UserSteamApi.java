...
public class UserSteamApi extends AbstractSteamApi {
	...
	public String getUserName(String userId) {
		...
		String xmlResponse = httpGet("http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?format=xml&"
				+ "key=" + SteamUtil.API_KEY + "&steamids=" + userId);
	...
	public List<UserApp> getOwnedGames(String userId) {
		...
		String xmlResponse = httpGet("http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?format=xml&"
				+ "key=" + SteamUtil.API_KEY + "&steamid=" + userId);
	...
	public UserAchievementSummary getUserAchievementsByAppId(String userId,
			long appId) {

		String xmlResponse = httpGet("https://api.steampowered.com/ISteamUserStats/GetPlayerAchievements/v1/?format=xml&"
				+ "key="
				+ SteamUtil.API_KEY
				+ "&steamid="
				+ userId
		...
		while (iterator.hasNext()) {
			Element achieved = iterator.next().getElementsByTag("achieved")
					.first();
	...
	public Map<String, Long> getUserStatisticsByAppId(String userId, long appId) {
		...
		String xmlResponse = httpGet("http://api.steampowered.com/ISteamUserStats/GetUserStatsForGame/v0002/?format=xml&"
				+ "key="
				+ SteamUtil.API_KEY
				+ "&steamid="
				+ userId
		...
		while (iterator.hasNext()) {
			...
			long value = Long.parseLong(statItem.getElementsByTag("value")
					.text());
